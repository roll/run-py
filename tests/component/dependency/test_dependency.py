...
class DependencyTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.module = Mock()
        self.attribute = Mock(meta_module=self.module)
    ...
    def test_invoke(self):
        ...
        self.module.meta_getattr.assert_called_with(
            'task', category=self.dependency._task_class, getvalue=True)
        # Check module meta_getattr's return value (task) call
        self.module.meta_getattr.return_value.assert_called_with(
            *self.args, **self.kwargs)

    def test_invoke_task_not_existent(self):
        self.module.meta_getattr.side_effect = AttributeError()
    ...
    def test_invoke_task_not_existent_and_strict_is_false(self, getLogger):
        ...
        # Check module meta_getattr's return value (task) call
        self.assertFalse(self.module.meta_getattr.return_value.called)
